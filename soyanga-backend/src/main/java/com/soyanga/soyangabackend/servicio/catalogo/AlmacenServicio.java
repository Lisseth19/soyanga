...
public class AlmacenServicio {
    ...
    public Page<AlmacenListadoProjection> listar(String q, Long idSucursal, boolean soloActivos, Pageable pageable) {
        String filtro = (q == null || q.isBlank()) ? null : q.trim();
        return repo.listar(filtro, idSucursal, soloActivos, pageable);
    }
     ...
     */
    public List<OpcionIdNombre> opciones(boolean soloActivos, Long idSucursal) {
        if (idSucursal != null) {
