...
public class PresentacionServicio {
    ...
    public Page<PresentacionDTO> buscar(Long idProducto, String q, Pageable pageable) {
        String pattern = (q == null || q.isBlank()) ? null : "%" + q.trim().toUpperCase() + "%";
        var page = presentacionRepo.buscar(idProducto, pattern, pageable);
    ...
    public CodigoBarrasDTO agregarCodigo(Long idPresentacion, CodigoBarrasCrearDTO dto) {
        // podría validar duplicados: UNIQUE (id_presentacion, codigo_barras) ya lo hace la BD
