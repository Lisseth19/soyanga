                              ...
                              <td className="px-4 py-3">
                                <div className="flex items-center gap-3">
                                  {can("almacenes:actualizar") && (
                                      <button className="text-neutral-700 hover:text-neutral-900" onClick={() => onEditar(a)}>
                                        Editar
                                      </button>
                                  )}
                                  {can("almacenes:actualizar") && (
                                  ...
                                  {can("almacenes:eliminar") && (
                                      <button className="text-red-600 hover:text-red-700" onClick={() => onDelete(a)}>
                                        Eliminar
                                      </button>
                                  )}
                                </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-4">
              <div className="bg-white border rounded-xl p-4">
                ...
                {/* Si NO puede crear y no está editando, muestra aviso en vez del formulario */}
