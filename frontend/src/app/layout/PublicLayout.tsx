...
function LogoBadge({ theme, size = "md" }: { theme: Theme; size?: "sm" | "md" }) {
    // Tamaños compactos para que no “se coma” la barra
    const pad = size === "sm" ? "p-1.5" : "p-2";
    const imgSize = size === "sm" ? "h-9 w-9" : "h-12 w-12";
    // Fondo bien oscuro en claro, y profundo en oscuro (mejor contraste con logo blanco)
    ...
    return (
        ...
        >
            <img
                src={logoP}
                alt="Soyanga"
                className={`${imgSize} object-contain select-none`}
                draggable={false}
            />
        </div>
    );
            ...
            <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--surface)]/90 backdrop-blur">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        {/* Logo con fondo también en desktop (pero compacto) */}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link
                                ...
                                className="grid place-items-center rounded-full bg-[var(--primary-color)] hover:opacity-90 transition h-10 w-10"
                            >
                    ...
                    <div className="md:hidden space-y-2">
                        {/* Fila 1: logo (un poco más grande) + tema + carrito */}
                        <div className="flex items-center gap-2">
                            ...
                            <div className="ml-auto flex items-center gap-2">
                                ...
                                <Link
                                    ...
                                    aria-label="Carrito / Cotización"
                                    title="Ver cotización"
                                    className="grid place-items-center rounded-full bg-[var(--primary-color)] hover:opacity-90 transition h-11 w-11"
                                >
                        ...
                        {/* Fila 2: navegación con scroll horizontal si no entra */}
